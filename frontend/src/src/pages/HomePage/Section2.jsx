      ...
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-20">
          {features.map((feature, index) => (
            <div 
              key={index}
              className="p-8 rounded-xl shadow-lg transition-all hover:shadow-xl bg-gray-800 border border-gray-700"
            >
        ...
        <div className="rounded-2xl overflow-hidden shadow-2xl bg-gradient-to-br from-gray-800 to-gray-700 border border-gray-600">
          <div className="grid md:grid-cols-2">
            <div className="p-10 md:p-12 flex flex-col justify-center">
              <h2 className="text-3xl font-bold mb-4 text-white">Start your MindFit journey</h2>
            ...
            <div className="hidden md:flex items-center justify-center p-8 bg-gray-800">
              <div className="relative w-full h-64">
                ...
                <div className="relative z-10 flex items-center justify-center h-full">
                  <div className="p-6 rounded-2xl shadow-lg bg-gray-900 border border-gray-700">
                    <div className="flex items-center mb-4">
                      <Dumbbell className="text-green-400 mr-3" />
                      <span className="font-semibold text-white">Today's MindFit Plan</span>
                    </div>
